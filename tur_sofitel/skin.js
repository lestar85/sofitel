...
function pano2vrSkin(player,base) {
	...
	player.addVariable('vis_thumbnail_menu_1', 2, false, { ignoreInState: 1  });
	...
	player.addVariable('node_visible_1', 2, false, { ignoreInState: 0  });
	player.addVariable('category_visible_2', 2, false, { ignoreInState: 1  });
	player.addVariable('node_visible_2', 2, false, { ignoreInState: 0  });
	player.addVariable('category_visible_3', 2, false, { ignoreInState: 1  });
	player.addVariable('node_visible_3', 2, false, { ignoreInState: 0  });
	player.addVariable('category_visible_4', 2, false, { ignoreInState: 1  });
	player.addVariable('node_visible_4', 2, false, { ignoreInState: 0  });
	player.addVariable('category_visible_5', 2, false, { ignoreInState: 1  });
	player.addVariable('node_visible_5', 2, false, { ignoreInState: 0  });
	var me=this;
	var skin=this;
	var flag=false;
	...
	this.addSkin=function() {
		...
		hs='data:image/png;base64,';
		...
		me._rectangle_40.onclick=function (e) {
			player.exitFullscreen();
			me._button_5.style.transition='none';
			me._button_5.style.visibility='hidden';
			me._button_5.ggVisible=false;
		...
		hs='data:image/png;base64,';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		...
		me._menu_background.logicBlock_alpha = function() {
			...
			if (me._menu_background.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._menu_background.style.transition='opacity 300ms ease 0ms';
				if (me._menu_background.ggCurrentLogicStateAlpha == 0) {
					...
					setTimeout(function() { if (me._menu_background.style.opacity == 0.0) { me._menu_background.style.visibility="hidden"; } }, 305);
		...
		elVertScrollBg.setAttribute('style', 'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 15px; height: 1050px; background-color: rgba(0,0,0,0.12549); pointer-events: auto;');
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._node_scroller__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		elVertScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 15px; height: 1050px; background-color: rgba(255,255,255,0.25098); pointer-events: auto;');
		...
		me._node_scroller.logicBlock_alpha = function() {
			...
			if (me._node_scroller.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._node_scroller.style.transition='opacity 300ms ease 0ms';
				if (me._node_scroller.ggCurrentLogicStateAlpha == 0) {
					...
					setTimeout(function() { if (me._node_scroller.style.opacity == 0.0) { me._node_scroller.style.visibility="hidden"; } }, 305);
		...
		el=me._menu_open_1=document.createElement('div');
		els=me._menu_open_1__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'c5IC04Ljc5Yy0wLjI3LC0wLjI3IC0wLjcxLC0wLjI3IC0wLjk4LDAgLTAuMjcsMC4yNyAtMC4yNywwLjcxIDAsMC45OGw4Ljc5IDguNzl6Ii8+CiAgPC9nPgogPC9nPgo8L3N2Zz4K';
		me._menu_open_1__img.setAttribute('src',hs);
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		els.setAttribute('style', hs);
		els['ondragstart']=function() { return false; };
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._menu_open_1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._menu_open_1.onclick=function (e) {
			player.setVariableValue('node_visible', !player.getVariableValue('node_visible'));
		...
		me._menu_open_1.ggUpdatePosition=function (useTransition) {
		}
		me._menu_background.appendChild(me._menu_open_1);
		...
		me._menu_background.appendChild(me._rectangle_1);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'MDFDMy40MTY2MyAzMS44MDM2IDQuMTgxNDcgMzIuNTY4NCA1LjEyNDk2IDMyLjU2ODRIMzUuODc1QzM2LjgxODQgMzIuNTY4NCAzNy41ODMzIDMxLjgwMzYgMzcuNTgzMyAzMC44NjAxQzM3LjU4MzMgMjkuOTE2NiAzNi44MTg0IDI5LjE1MTggMzUuODc1IDI5LjE1MThINS4xMjQ5NloiLz4KPC9zdmc+Cg==';
	...
	function SkinCloner_node_cloner_Class(nodeId, parentScope, ggParent, parameter) {
		...
		hs+='cursor : default;';
		hs+='height : 117px;';
		hs+='left : calc(50% - ((183px + 6px) / 2) + 0px);';
		hs+='opacity : 0.8;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((117px + 6px) / 2) + 1px);';
		hs+='visibility : inherit;';
		hs+='width : 183px;';
		hs+='pointer-events:none;';
		el.setAttribute('style',hs);
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'';
		...
		hs='data:image/svg+xml;base64,'+
			''+
			'';
		...
		me._hotspot_preview.appendChild(me._text_1);
